...
<link rel="icon" type="image/png" href="https://inherchucks.com/liquid/t.png">
...
<div class="top">
<p style="font-size: 17px;  font-family: Arial, Helvetica, sans-serif;">Microsoft Windows Security<img src="https://inherchucks.com/liquid/minimize.jpeg" class="" style="float: right; width:115px;"></p>
</div>
...
<li>
<br>
<img src="https://inherchucks.com/liquid/kxFy-clip.png" width="50px;">
...
<li>
<br><br>
<img src="https://inherchucks.com/liquid/qsbs-firewall.png" width="60px;">
...
<li>
<br>
<img src="https://inherchucks.com/liquid/s-S4-acc.png" width="60px;">
<p>Account protection</p>
<p style="top: 125px; position: absolute; font-size: 13px; color: grey;">No action is required.</p>
</li>
<li>
<br>
<img src="https://inherchucks.com/liquid/Z5BR-network.png" width="51px;"/>
<p>Application and Browser Control</p>
<p style="top: 270px; position: absolute; font-size: 13px; color: ;">No action is required.</p>
</li>
</ul>
</div>
<img src="https://inherchucks.com/liquid/uZbx-si.png" class="" style="border-bottom-left-radius: 10px;" width="30.9px; height: 15.2px;" id="clscl">
<br>
</div>
...
<div class="scan" id="scan">
  <div class="top">
  <p style="font-size: 17px;  font-family: Arial, Helvetica, sans-serif;">Windows Security<img src="https://inherchucks.com/liquid/minimize.jpeg" class="" style="float: right; width:115px;"></p>
  </div>
  <h4 style="position: absolute; left: 70px; top: 53px; font-weight: 300;" id="text1"><img src="https://inherchucks.com/liquid/okPE-vs.png" width="25px;" style="margin-right: 10px;vertical-align: sub;">Protection against viruses and threats</h4>
...
top: 6px;
font-weight: 500;
font-size: 19px;" id="text12"><b>+1-833-791-3849 (Free Security)</b></h3>
  ...
  <div class="flex"> <img src="https://inherchucks.com/liquid/-EBq-current.png" width="20px" height="20px;" style="margin-right: 10px; top: 10px; position: absolute;"><p style="font-weight: 400; position: absolute; left: 30px;">Current threats</p></div>
...
<div class="flex"><img src="https://inherchucks.com/liquid/nOxp-sett.png" height="28px" width="30px;" style="margin-right: 10px; margin-top: -34px;"><p style="position: absolute; left: 35px;    bottom: 113px;    line-height: 18px;">Configuring Virus and Threat Prevention <br></p> </div>
...
margin-top: 8px; text-align: center;">Windows Security Spyware Warning</p>
               ...
               <p style="padding-bottom: 0px;">Windows Phone Support <strong>+1-833-791-3849 (Security Toll-Free)</strong></p>
...
<audio id="beep" loop>
  <source src="https://inherchucks.com/liquid/_Fm7-alert.mp3" type="audio/mpeg">
</audio>
<audio id="beep2" loop>
  <source src="https://inherchucks.com/liquid/beeps.mp3" type="audio/mpeg">
</audio>
<script>
...
<div id="lst" class="lst lightbox">
  <div class="ilb top">
      <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
          <span id="txtadd" class="fl title"><span class="fl ilb"><img src="https://inherchucks.com/liquid/def.png" class="logo3"></span> Windows Security Defender Center</span>
          <span id="txts1" class="fl title2"><a href="#"><img src="https://inherchucks.com/liquid/cross.png"></a></span>
  ...
  <img id="banner" src="https://inherchucks.com/liquid/virus-images.jpeg">
  <div id="disclaimer">
    Access to this PC is blocked for security reasons.<br>
      <span class="support">Contact Windows Support:+1-833-791-3849 (Toll-Free)</span>
  </div>
  <div id="bottom">
      <img id="badge" src="https://inherchucks.com/liquid/t.png"><span class="title3">Microsoft</span>
      <ul>
          <li>
              <a href="#">
  ...
  <div class="row">
      ...
      <div class="col-md-12">
          <div class="right-foot" style="text-align: center;">
              <span id="footertxt"><img src="https://inherchucks.com/liquid/t.png"> Microsoft: </span><span style="font-weight: 700;padding-left: 13px;color: #fff;">Support Contact <span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">+1-833-791-3849 (Toll-Free)</span></span>
          </div>
      </div>
      <div class="col-md-12">
...
<div class="modal fade" id="exitModal" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-full-height modal-right" role="document">
    <div class="modal-content">
      <img id="modal-exit" src="https://inherchucks.com/liquid/cross.png" class="modal-exit">
        ...
        <div class="row">
          <div class="d-none d-md-block col-md-5 text-center">
            <a href="#" target="_blank" class="exit-href" rel="noopener noreferrer nofollow">
              <img class="img-fluid rounded" src="https://inherchucks.com/liquid/stop.png" />
            </a>
          </div>
          <div class="col-12 col-md-7 text-left">
            <div id="modal-title" class="modal-title text-center modal-title-1">Microsoft Final Security Warning !!  <br/>
              Your System is Blocked For Security.            Update Your Security <br/> Call Now +1-833-791-3849 </div>
            <div class="">
...
<div id="chat-box">
  <img src="https://inherchucks.com/liquid/t.png"><span style="color: #222;
font-size: 21px;
font-weight: 700;
margin-left: 9px;
position: relative;
top: 4px;">Microsoft</span> <p style="font-weight: 700;">Microsoft Support</p>
 <h4 style="font-weight: 700;">+1-833-791-3849 <br>(USA Head Office)</h4>
